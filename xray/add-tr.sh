...
clear
echo -e "\e[33m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m" | tee -a /etc/log-create-trojan.log
echo -e "\E[40;1;37m        TROJAN ACCOUNT          \E[0m" | tee -a /etc/log-create-trojan.log
echo -e "\e[33m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m" | tee -a /etc/log-create-trojan.log
echo -e "Remarks      : ${user}" | tee -a /etc/log-create-trojan.log
echo -e "Host/IP      : ${domain}" | tee -a /etc/log-create-trojan.log
echo -e "port         : 443/80" | tee -a /etc/log-create-trojan.log
...
echo -e "\e[33m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m" | tee -a /etc/log-create-trojan.log
echo -e "Link WS      : ${trojanlink}" | tee -a /etc/log-create-trojan.log
echo -e "\e[33m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m" | tee -a /etc/log-create-trojan.log

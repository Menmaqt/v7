...
echo -e ""
echo -e "${BIYellow}╒══════════════════════════════════════════════════════╕${NC}" 
echo -e " \E[0;103m                 ${BIBlack}SYSTEM INFORMATION                   \e[0m"
echo -e "${BIYellow}╘══════════════════════════════════════════════════════╛${NC}"
...
echo -e "${BIYellow}╒══════════════════════════════════════════════════════╕${NC}" 
echo -e " \E[0;103m                ${BIBlack}SERVICES INFORMATION                  \e[0m"
echo -e "${BIYellow}╘══════════════════════════════════════════════════════╛${NC}"
...
echo -e " 🔰 XRAYS Vmess GRPC        :$status_nontls_v2ray"
echo -e " 🔰 XRAYS Vless TLS         :$status_tls_vless"
echo -e " 🔰 XRAYS Vless None TLS    :$status_nontls_vless"
echo -e " 🔰 XRAYS Vless GRPC        :$status_nontls_vless"

...
echo ""
wget -q https://raw.githubusercontent.com/Menmaqt/v7/main/tools.sh;chmod +x tools.sh;./tools.sh
rm tools.sh
clear
echo -e "$BYellow.-----------------------------------------------.${NC}"
echo -e "$BYellow|            Please Insert Your Name            |${NC}"
echo -e "$BYellow'-----------------------------------------------'${NC}"
echo -e ""
read -rp " Enter Name / Masukkan Nama : " -e nama
echo $nama > /usr/local/etc/nama
...
echo -e "$BYellow-------------------------------------------------------------------$NC"
read -rp "Enter Your Domain / Masukkan Domain : " -e pp
    if [ -z $pp ]; then
        echo -e "
...
sleep 0.5
clear
wget https://raw.githubusercontent.com/Menmaqt/v7/main/ssh/ssh-vpn.sh && chmod +x ssh-vpn.sh && ./ssh-vpn.sh
...
sleep 0.5
clear
wget https://raw.githubusercontent.com/Menmaqt/v7/main/xray/ins-xray.sh && chmod +x ins-xray.sh && ./ins-xray.sh
wget https://raw.githubusercontent.com/Menmaqt/v7/main/sshws/insshws.sh && chmod +x insshws.sh && ./insshws.sh
clear
